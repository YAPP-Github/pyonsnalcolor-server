...
public enum Category implements Filter {
    ...
    FOOD(1002, "식품",
            "https://github.com/YAPP-Github/pyonsnalcolor-server/assets/77563814/690e7cb1-962b-4e79-8c81-f0f5d1adb772",
    ...
    BAKERY(1006, "베이커리",
            "https://github.com/YAPP-Github/pyonsnalcolor-server/assets/77563814/aa118218-e555-4ece-9978-a6493337b76d",
            Arrays.asList("만쥬", "케익", "케이크", "페스츄리", "바게트", "카롱",
                    "빵", "카스테라", "도넛", "도너츠", "마들렌", "마카롱","머핀", "브레드", "브라우니", "와플")),
    SNACK(1004, "과자류",
            "https://github.com/YAPP-Github/pyonsnalcolor-server/assets/77563814/dc7f4bfa-0232-4bd5-b894-14ce34042cf1",
            Arrays.asList("비스킷", "떠먹는", "초콜릿", "파이", "오레오", "와플", "꼬깔콘", "산도",
                    ...
                    "나쵸", "웨이퍼", "어니언", "바프")),
    DRINK(1003, "음료",
            "https://github.com/YAPP-Github/pyonsnalcolor-server/assets/77563814/58209d39-d5c0-436b-9e78-11620964c4d6",
    ...
    ICE_CREAM(1005, "아이스크림",
            "https://github.com/YAPP-Github/pyonsnalcolor-server/assets/77563814/cd28d784-377c-45f5-8fa8-9f48b5a0367d",
            Arrays.asList("파르페", "탱크보이", "슈퍼콘", "월드콘", "우유콘", "설레임",
                    "아이스", "하겐다즈", "부라보콘", "메로나", "죠스바", "구구콘", "수박바", "비비빅", "쌍쌍바", "쉐이크", "스크류바",
                    "옥동자", "모나카", "빙수",
                    "찰옥수수", "더블비얀코", "보석바", "돼지바", "빠삐코", "빵빠레", "파인트")),
    GOODS(1001, "생활용품",
            "https://github.com/YAPP-Github/pyonsnalcolor-server/assets/77563814/056d1225-fca6-4553-be7f-97234fce2512",
